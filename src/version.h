 ...
 * auto-names the project from IPMAN_HOME, --next renders the project
 * block, workspace.export op is the companion to plan.export). All
 * patches stay wire-additive. See docs/v2.3-tools-and-env-vars.md.
 */
#define IPMAN_VERSION "2.3.2"
